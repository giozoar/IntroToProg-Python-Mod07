...
#   Giovanna Torres, 3/12/2025, Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Student(Person):
    ...
    """
      A collection data about students and their registered course.

      ChangeLog: (Who, When, What)
      Giovanna Torres, 3/12/2025,Created Class
      """
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            student: Student = Student(first_name=student_first_name, last_name=student_last_name, course_name=course_name)
